...
1. 现有AX=2000H，BX=1200H，DS=3000H，DI=0002H，(31200H)=50H，(31201H)=02H，(31202H)=40H，请写出下列各条指令独立执行完后有关寄存器及存储单元的内容，并指出标志位ZF、CF的值。
   ...
   B. SUB AX,BX    ;问 AX= _______ H，ZF= _______ （(0800H、0)[]）<br>
   C. MOV AX,[BX]  ;问 AX= _______ H，CF= _______ （(3200H、0)[]）<br>
   D. NEG WORD PTR [1200H];问 (31200H)= _______ H，CF= _______ （(3200H、0)[]）
